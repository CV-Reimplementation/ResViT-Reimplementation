...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='../dataset/MRI-PET', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='res_cnn', help='selects model to use for netG')
        self.parser.add_argument('--n_layers_D', type=int, default=3, help='only used if which_model_netD==n_layers')
        self.parser.add_argument('--gpu_ids', type=str, default='0,1,2,3', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--name', type=str, default='MRI-PET', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--model', type=str, default='resvit_one',
